...
QT_MOC_LITERAL(4, 37, 4) // "item"
    ...
    "RectItem\0itemsChange\0\0QGraphicsItem*\0"
    "item"
};
...
void RectItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RectItem::*)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RectItem::itemsChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RectItem::itemsChange(QGraphicsItem * _t1)
{
