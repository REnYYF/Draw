...
QT_MOC_LITERAL(4, 40, 4) // "item"
    ...
    "EllipseItem\0itemsChange\0\0QGraphicsItem*\0"
    "item"
};
...
void EllipseItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EllipseItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (EllipseItem::*)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EllipseItem::itemsChange)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void EllipseItem::itemsChange(QGraphicsItem * _t1)
{
